...
public enum Note {A(4,440),As(4,466.16),B(4,493.88),C(5,440),Cs(5,440),D(5,440),Ds(5,440),E(5,440),F(5,440),Fs(5,440),G(5,440),Gs(5,440);
double frequency;
int octave;

Note(int octave,double frequency){
    this.octave = octave;
